...
const Footer = () => {
  return (
    <footer className="bg-[#4F46E5] text-white mt-5 py-8">
      <div className="max-w-6xl mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left">
          {/* Brand Section */}
          <div>
            <h2 className="text-xl font-bold text-[#F8FAFC]">FreelancerBox</h2>
        ...
        <div className="border-t border-[#6366F1] mt-6 pt-4 text-center text-gray-300">
          &copy; {new Date().getFullYear()} FreelancerBox. All rights reserved.
        </div>
      </div>
    </footer>
  );
